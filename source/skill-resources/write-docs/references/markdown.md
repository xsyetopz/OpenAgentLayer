...
Use CommonMark and GitHub Flavored Markdown for repository docs. GitHub Markdown alerts fit GitHub-rendered notes. The Markdown Guide, Google developer write-docs guidance, Microsoft style guide, and Diataxis can shape public docs when the audience and artifact need them.
