...
- Use a Conventional Commits subject: `<type>[optional scope]: <description>`
- Use a lowercase type such as `feat`, `fix`, `docs`, `test`, `refactor`, `chore`, `ci`, or `build`
- Keep the subject at 72 characters or less and do not end it with a period
- Use `!` before `:` for breaking changes and include a `BREAKING CHANGE:` footer when applicable
