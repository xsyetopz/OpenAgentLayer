...
For broad implement prompts, include a delegation check. Use subagents or an orchestration route when work can split by owner, provider, package, test tier, or investigation path. Narrow single-owner edits begin with a recorded solo ownership reason.
