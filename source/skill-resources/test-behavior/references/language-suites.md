...
- Use golden tests for stable generated artifacts when the diff is human-review-changesable.
- Use snapshot tests when the snapshot is small, intentional, and reviewed.
- Use mutation test-behavior when branch coverage needs audit-safety-critical reinforcement.
