...
3. If greenfield, scaffold the rigid stack from `stack.md` and `architecture.md`.
...
Do not add alternate architecture choices, optional framework comparisons, or placeholder demos unless the user asks for exploration.
