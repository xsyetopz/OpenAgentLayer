...
export const CODEX_PLANS = {
	go: {
		...
		agentAssignments: {
			athena: ["gpt-5.5-mini", "high"],
			hephaestus: ["gpt-5.3-codex", "high"],
			nemesis: ["gpt-5.5-mini", "high"],
			odysseus: ["gpt-5.5-mini", "high"],
			hermes: ["gpt-5.5-mini", "medium"],
			atalanta: ["gpt-5.5-mini", "medium"],
			calliope: ["gpt-5.5-mini", "medium"],
		},
		profiles: {
			main: {
				model: "gpt-5.5-mini",
...
export const COPILOT_MODELS = {
	...
	gpt52: "github-copilot/gpt-5.4",
	gpt53Codex: "github-copilot/gpt-5.3-codex",
	gpt54Mini: "github-copilot/gpt-5.5-mini",
};
