...
- Use the active Codex plan preset. Default top-level planning/editing to `gpt-5.5` on eligible plans (`plus`, `pro-5`, `pro-20`), keep implementation/review routes on `gpt-5.3-codex`, and keep bounded utility work on the utility profile.
