...
- **Evidence contract:** final output names changed behavior, touched source, generated artifacts when relevant, validation commands, and Attempted/Evidence/Need fields when a handoff-ready `STATUS BLOCKED` result is the correct outcome.
