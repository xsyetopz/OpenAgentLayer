...
- **Skill intake contract:** add or keep skills only when they are source-backed, high-signal, and expected to be reused; use catalogs as discovery inputs, then author OAL-local skills piece by piece for concrete project needs.
