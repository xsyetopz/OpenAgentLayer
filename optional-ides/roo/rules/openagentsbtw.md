# openagentsbtw Roo Code Instructions
...
- Use Roo Code native instruction/rule surfaces; openagentsbtw guidance is additive.
...
- Hook status: Roo Code hook parity is unavailable; guardrails are rule/mode based..
