...
rtk gain --opportunities  # commands with most recoverable savings
...
rtk gain --opportunities --format json > opportunities.json
```
...
```bash
# Find the next filters or rewrites to improve
rtk gain --opportunities
