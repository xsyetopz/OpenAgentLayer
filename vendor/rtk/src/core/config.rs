...
pub struct TrackingConfig {
    ...
    pub enabled: bool,
    #[serde(default = "default_tracking_history_days")]
...
fn default_tracking_history_days() -> u32 {
    DEFAULT_HISTORY_DAYS as u32
}
...
impl Default for TrackingConfig {
    fn default() -> Self {
        Self {
            ...
            history_days: default_tracking_history_days(),
            database_path: None,
        }
    }
}
...
"#;
    ...
    #[test]
    fn test_partial_tracking_config_defaults() {
        let toml = r#"
[tracking]
database_path = "/tmp/rtk/history.db"
"#;
        let config: Config = toml::from_str(toml).expect("valid toml");
        ...
        assert_eq!(
            ...
            Some(PathBuf::from("/tmp/rtk/history.db"))
        );
    }
