...
Triggers: work requires planning, package boundaries, API design; Athena owns the requested route or risk area; provider-specific OAL behavior needs evidence
