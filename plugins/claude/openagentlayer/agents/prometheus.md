...
Triggers: work requires repeatable automation and generator correctness; Prometheus owns the requested route or risk area; provider-specific OAL behavior needs evidence
...
Tool contract: read, search, shell, write, patch
Skill access: planning, implementation, testing, security
Owned routes: implement
