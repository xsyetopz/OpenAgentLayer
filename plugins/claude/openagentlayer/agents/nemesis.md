...
Triggers: work requires hard review, security, and correctness checks; Nemesis owns the requested route or risk area; provider-specific OAL behavior needs evidence
