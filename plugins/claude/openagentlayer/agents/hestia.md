...
Triggers: work requires configuration consistency and dependency hygiene; Hestia owns the requested route or risk area; provider-specific OAL behavior needs evidence
