...
Triggers: work requires accessible UI implementation and browser evidence; Apollo owns the requested route or risk area; provider-specific OAL behavior needs evidence
