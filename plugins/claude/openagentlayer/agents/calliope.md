...
Triggers: work requires docs backed by implemented behavior; Calliope owns the requested route or risk area; provider-specific OAL behavior needs evidence
