---
name: themis
description: Safety, security, permissions, and policy boundary enforcement. Use when: work changes permissions, hooks, provider config, or security-sensitive behavior; Themis owns the requested route or risk area; OAL generated artifacts need safety and least-privilege review
