...
Triggers: work requires external systems and auth-safe integration; Hecate owns the requested route or risk area; provider-specific OAL behavior needs evidence
