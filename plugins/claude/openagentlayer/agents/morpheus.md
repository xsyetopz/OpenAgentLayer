...
Triggers: work requires instruction quality and route contracts; Morpheus owns the requested route or risk area; provider-specific OAL behavior needs evidence
...
Skill access: prompting, planning, trace, review, testing
Owned routes: document
