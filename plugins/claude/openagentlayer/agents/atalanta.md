...
Triggers: work requires commands, fixtures, and failure diagnosis; Atalanta owns the requested route or risk area; provider-specific OAL behavior needs evidence
...
Owned routes: test, validate, accept
