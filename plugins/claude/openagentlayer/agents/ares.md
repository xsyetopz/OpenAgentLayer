...
Triggers: work requires aggressive repro and edge-case testing; Ares owns the requested route or risk area; provider-specific OAL behavior needs evidence
