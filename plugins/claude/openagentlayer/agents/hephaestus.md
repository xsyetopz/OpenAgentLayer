...
Triggers: work requires complete code changes with tests and no stubs; Hephaestus owns the requested route or risk area; provider-specific OAL behavior needs evidence
