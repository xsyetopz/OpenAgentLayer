...
Triggers: work requires read-only codebase research and source evidence; Hermes owns the requested route or risk area; provider-specific OAL behavior needs evidence
