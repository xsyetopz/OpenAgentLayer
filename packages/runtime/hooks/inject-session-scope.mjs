...
const SESSION_SCOPE_DETAILS = [
	...
	"Implementation routing rule: for significant or separable coding implementation, spawn rendered GPT-5.3-Codex implementation agents such as hephaestus, daedalus, demeter, hecate, or prometheus instead of having the GPT-5.5 parent do all edits; do not treat lower GPT-5.5 reasoning effort as the main cost control for constant goal loops.",
